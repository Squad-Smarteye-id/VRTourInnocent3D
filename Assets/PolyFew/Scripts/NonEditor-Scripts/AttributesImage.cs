...
namespace BrainFailProductions.PolyFew
{
    ...
    [UnityEditor.AssetImporters.ScriptedImporter(1, "atim")]
    public class AttributesImage : UnityEditor.AssetImporters.ScriptedImporter
    {
        ...
        public override void OnImportAsset(UnityEditor.AssetImporters.AssetImportContext impContext)
        {
